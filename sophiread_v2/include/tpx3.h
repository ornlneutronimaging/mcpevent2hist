...
class Hit {
    public:
        Hit(const int x, const int y, const int tot, const int toa, const int ftoa, const unsigned int tof);
        ~Hit();
        int getX() const;
        int getY() const;
        int getTOT() const;
        int getTOA() const;
        unsigned int getTOF() const;
        double getTOF_ns() const;
        double getTOA_ns() const;
        double getTOT_ns() const;
