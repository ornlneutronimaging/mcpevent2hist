          ...
          switch (packet) {
            ...
            case 0xb:  // Chip data: ToA and ToT timestamp packet, x, y
              ...
              ************************************************************/
              ...
              xy_file << setprecision(15) << x << "  " << y << "  " << global_timestamp / 1E9 << "  " << TOTns
                      << endl;  // x, y, toa, tot data can be saved into txt data
              cout << "Chip-ToA: " << setprecision(15) << global_timestamp / 1E9 << "  ToT: " << TOTns << " x: " << x
                   << " y: " << y << endl;
            ...
            case 0x4:  // the global timestamps.
              ...
              if (((temp >> 56) & 0xF) == 0x4) {
                ...
                xy_file << " Global time: " << setprecision(15) << timemaster * 25e-9
