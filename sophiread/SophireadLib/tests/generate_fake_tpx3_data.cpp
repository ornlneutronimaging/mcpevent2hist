...
unsigned long long packDataHeader(unsigned long long t, unsigned long long p, unsigned long long x,
                                  unsigned long long three, unsigned long long chip_nr, unsigned long long mode,
                                  unsigned long long num_bytes) {
  unsigned long long header;
  header = ((num_bytes & 0x000000000000FFFF) << 48) | ((mode & 0x00000000000000FF) << 40) |
           ((chip_nr & 0x00000000000000FF) << 32) | ((three & 0x00000000000000FF) << 24) |
           ((x & 0x00000000000000FF) << 16) | ((p & 0x00000000000000FF) << 8) | (t & 0x00000000000000FF);
...
unsigned long long packPixelHit(unsigned long long spider_time, unsigned long long ftoa, unsigned long long TOT,
                                unsigned long long TOA, unsigned long long pixaddr) {
  unsigned long long temp;
  unsigned long long header = 0xb;

  temp = ((header & 0x00000000000000FF) << 60) | ((pixaddr & 0x000000000000FFFF) << 44) |
         ((TOA & 0x0000000000003FFF) << 30) | ((TOT & 0x00000000000003FF) << 20) | ((ftoa & 0x00000000000000FF) << 16) |
